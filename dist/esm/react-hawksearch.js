...
function OpenRangeDatetime() {
  ...
  var rangeStartDate = daterange && daterange.RangeStart ? daterange.RangeStart.slice(0, 16) : '';
  var rangeEndDate = daterange && daterange.RangeEnd ? daterange.RangeEnd.slice(0, 16) : ''; // if there's no range, initialize to empty strings
...
function AutoCorrectSuggestion() {
  ...
  }, searchResults && searchResults.DidYouMean ? React__default.createElement("ul", {
...
export { AuthToken$1 as AuthToken, AutoCorrectSuggestion, Checkbox, CompareItems, ConfigProvider, ContentType, Facet$1 as Facet, FacetList, FacetRail, FacetSelectionState, FacetType, GlobalSearchBox, Hawksearch, Link, Nested as NestedCheckbox, NestedLink, OpenRange, Pagination$1 as Pagination, PlaceholderItem, QueryStringListener, RedirectURLListener, ResultImage, ResultListing, Results, RuleOperatorType, RuleType, Search, SearchBox, SearchResultsLabel, Selections$1 as Selections, Size, Slider, Sorting$1 as Sorting, Spinner, StoreProvider, Suggestion, SuggestionType, Swatch$1 as Swatch, SwatchItem, ToolRow, TrackingEvent$1 as TrackingEvent, checkIfUrlRefsLandingPage, createGuid, getCookie, getSearchQueryString, getVisitExpiry, getVisitorExpiry, parseLocation, parseSearchQueryString, setCookie, i18next as tConfig, useFacet, useHawksearch };
